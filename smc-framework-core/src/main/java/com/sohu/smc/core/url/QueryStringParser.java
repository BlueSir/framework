 ...
 *
 * <p>
 * Based on Netty {@link org.jboss.netty.handler.codec.http.QueryStringDecoder} with URL decoding removed for
 * selective query-string parameter decoding.
 * </p>
 *
 * @see org.jboss.netty.handler.codec.http.QueryStringDecoder
