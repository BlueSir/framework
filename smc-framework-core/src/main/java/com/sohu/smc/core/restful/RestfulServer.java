...
public final class RestfulServer {
	public static final String PROPERTY_BASE_URI = "com.sohu.smc.core.restful.baseUri";

	private static final Logger LOG = LoggerFactory
			.getLogger(RestfulServer.class);
	...
	RestfulServer(final ChannelPipelineFactory pipelineFactory,
