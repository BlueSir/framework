...
public class AssetsBundle implements Bundle {
    ...
    /**
     * Creates a new {@link com.sohu.smc.core.bundles.AssetsBundle} which serves up static assets from
     * {@code src/main/resources/assets/*} as {@code /assets/*}.
     *
     * @see com.sohu.smc.core.bundles.AssetsBundle#AssetsBundle(String, int)
     */
    public AssetsBundle() {
    ...
    /**
     * Creates a new {@link com.sohu.smc.core.bundles.AssetsBundle} which will configure the service to serve the static files
