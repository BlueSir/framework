...
import com.sohu.smc.core.jmemcached.protocol.ResponseMessage;
import com.sohu.smc.core.jmemcached.protocol.exceptions.ClientException;
...
import static com.sohu.smc.core.jmemcached.protocol.text.MemcachedPipelineFactory.USASCII;
...
public final class MemcachedResponseEncoder<CACHE_ELEMENT extends CacheElement> extends SimpleChannelUpstreamHandler {
    ...
    private ChannelBuffer deleteResponseString(MemcachedHandler.DeleteResponse deleteResponse) {
        if (deleteResponse == MemcachedHandler.DeleteResponse.DELETED) return DELETED.duplicate();
     ...
     */
    private ChannelBuffer storeResponse(MemcachedHandler.StoreResponse storeResponse) {
