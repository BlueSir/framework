...
final class RowSeq implements DataPoints {
   ...
   * merge them into the same {@link com.sohu.smc.service.consumers.opentsdb.core.RowSeq} instance in memory in order to save
   * RAM.
  ...
  /**
   * Checks whether a time delta is short enough for a {@link com.sohu.smc.service.consumers.opentsdb.core.RowSeq}.
   * @param time_delta A time delta in seconds.
   * @return {@code true} if the delta is small enough that two data points
   * separated by the time delta can fit together in the same {@link com.sohu.smc.service.consumers.opentsdb.core.RowSeq},
   * {@code false} if they're distant enough in time that they must go in
   * different {@link com.sohu.smc.service.consumers.opentsdb.core.RowSeq} instances.
   */
  ...
  /** Package private iterator method to access it as a {@link com.sohu.smc.service.consumers.opentsdb.core.RowSeq.Iterator}. */
  ...
  /** Iterator for {@link com.sohu.smc.service.consumers.opentsdb.core.RowSeq}s.  */
