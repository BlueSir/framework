...
final class Span implements DataPoints {
  ...
  /** Iterator for {@link com.sohu.smc.service.consumers.opentsdb.core.Span}s. */
  ...
  DownsamplingIterator downsampler(final int interval,
                                        final Aggregator downsampler) {
    return new DownsamplingIterator(interval, downsampler);
  }
   ...
   * {@link com.sohu.smc.service.consumers.opentsdb.core.Span} have {@code O(1)} access to individual data points, in order
   * to be efficient.
   */
