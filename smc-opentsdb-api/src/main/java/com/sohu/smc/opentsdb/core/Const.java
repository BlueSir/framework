...
public final class Const {
    ...
    public static final int COMPACTED_TIMESPAN_1m = 60;

    public static final int COMPACTED_TIMESPAN_5m = 300;

    public static final int COMPACTED_TIMESPAN_60m = 3600;

    public static final int COMPACTED_TIMESPAN_1d = 3600 * 24;
