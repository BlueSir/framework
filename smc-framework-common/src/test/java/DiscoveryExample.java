...
public class DiscoveryExample {
    private static final String PATH = "/smc/mqtt/broker-test";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            client = CuratorFrameworkFactory.newClient(PropertyConfig.getZookeeperAddress(), new ExponentialBackoffRetry(1000, 3));
            client.start();
