...
public class KryoSerializingTranscoder extends BaseSerializingTranscoder implements
        Transcoder<Object> {
     ...
     */
    public KryoSerializingTranscoder() {
     ...
     */
    public KryoSerializingTranscoder(int max) {
        super(max);
    }
